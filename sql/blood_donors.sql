...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 16, 2024 at 07:29 AM
...
INSERT INTO `user` (`nid`, `full_name`, `user_name`, `password`, `father_name`, `mother_name`, `email`, `phone`, `dob`, `gender`, `blood_group`, `village`, `post_office`, `thana`, `zilla`, `division`, `photo`, `user_type`, `status`) VALUES
('140203020001', 'Topu Dash Roy', 'topu', '12345', 'f_topu', 'm_topu', 'topu@yahoo.com', '+8801710000000', '30 Dec', 'male', 'A+', 'sylhet', 'sylhet', 'sylhet', 'sylhet', 'sylhet', 'Uploading error in image', 'accepted', 'active'),
('140203020002', 'Pranta Sarker', 'pranta', '54321', 'f_pranta', 'm_pranta', 'pranta@gmail.com', '+8801634543211', '26 Jan', 'male', 'O+', 'sylhet', 'sylhet', 'sylhet', 'sylhet', 'sylhet', 'Uploading error in image', 'accepted', 'active');
